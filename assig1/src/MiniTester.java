...
public class MiniTester {
    ...
    private static void angryBeeTest1() {
        ...
        Hornet hornet = new Hornet(t, 10, 2);
        if (!bee.takeAction()) {
            System.out.println("AngryBee: takeAction() returns the wrong value. (expected: true, actual: false)");
            containsError = true;
        }
        if (hornet.getHealth() != 8) {
            System.out.println("AngryBee: takeAction() does the wrong amount of damage to hornet. " +
    ...
    private static void angryBeeTest2() {
        ...
        AngryBee bee = new AngryBee(t, 2);
        if (bee.takeAction()) {
            System.out.println("AngryBee: takeAction() returns the wrong value. Expected: false, actual: true");
            containsError = true;
        }
    }
    ...
    private static void angryBeeTest4() {
        ...
        AngryBee bee = new AngryBee(t, 2);
        if (bee.getHealth() != 10) {
            System.out.println("AngryBee: Health is initialized to a wrong value. " +
                    "Expected: 10, actual: "+bee.getHealth());
            containsError = true;
        }
        if (bee.getCost() != 1) {
            System.out.println("AngryBee: Food cost is initialized to a wrong value. " +
    ...
    private static void swarmOfHornetsTest6() {
        ...
        if (swarm.sizeOfSwarm() != 1 || !Arrays.equals(swarm.getHornets(), expected)) {
            System.out.println(swarm.sizeOfSwarm());
    ...
    private static void movingFromSwarmTest() {
        Tile t1 = new Tile();
        t1.buildNest();
        Tile t2 = new Tile();
        Tile t3 = new Tile();
        t3.buildHive();
        t2.createPath(t3, t1);
        t1.createPath(t2, null);
        t3.createPath(null, t2);

        Hornet hornet1 = new Hornet(t1, 5, 5);
        Hornet hornet2 = new Hornet(t1, 5, 5);
        if (t1.getNumOfHornets() != 2) {
            System.out.println("Hornets not added to tile correctly");
            containsError = true;
        }
        t1.removeInsect(hornet1);
        t2.addInsect(hornet1);
        if (t1.getNumOfHornets() != 1 || t2.getNumOfHornets() != 1) {
            System.out.println("Hornets not moving correctly from tile to tile");
            containsError = true;
        }
        t1.removeInsect(hornet2);
        t2.addInsect(hornet2);
        if (t1.getNumOfHornets() != 0 || t2.getNumOfHornets() != 2) {
            System.out.println("Hornets not moving correctly from tile to tile");
            containsError = true;
        }
    }

    private static void movingFromSwarmTest2() {
        Tile t1 = new Tile();
        t1.buildNest();
        Tile t2 = new Tile();
        Tile t3 = new Tile();
        ...
        Hornet hornet1 = new Hornet(t1, 5, 5);
        Hornet hornet2 = new Hornet(t1, 5, 5);
        hornet1.takeAction(); // move towards hive, should move hornet 1 from tile 1 to tile 2
        if (t1.getNumOfHornets() != 1 || t2.getNumOfHornets() != 1) {
            System.out.println("Hornets not moving correctly from tile to tile during takeAction. Hornets on t1:" + t1.getNumOfHornets() +
                    " Hornets on t2: " + t2.getNumOfHornets());
            containsError = true;
        }
        hornet2.takeAction();
        if (t1.getNumOfHornets() != 0 || t2.getNumOfHornets() != 2) {
        ...
        hornet1.takeAction(); // move towards hive, should move hornet 1 from tile 1 to tile 2
        if (t1.getNumOfHornets() != 0 || t2.getNumOfHornets() != 1) {
            System.out.println("Hornets not moving correctly from tile to tile during takeAction. Hornets on t1:" + t1.getNumOfHornets() +
                    " Hornets on t2: " + t2.getNumOfHornets());
            containsError = true;
        }
    ...
    private static void angryBeePositionTest() {
        Tile t1 = new Tile();
        t1.buildNest();
        Tile t2 = new Tile();
        Tile t3 = new Tile();
        ...
        t1.createPath(t2, null);
        t3.createPath(null, t2);
        Hornet hornet = new Hornet(t1, 2, 1);
        AngryBee angry = new AngryBee(t3, 3);
        angry.takeAction();
        if (angry.getPosition() != t3) {
            System.out.println("AngryBee position is not updated correctly. Expected: " + t3 + " is on " + angry.getPosition());
            containsError = true;
        }
    }
}
